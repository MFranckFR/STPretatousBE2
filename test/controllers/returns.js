...
var returns = require('../../controllers/Returns.js');
...
var objId1 = db.Returns._mongoose.Types.ObjectId();
describe('Returns controller', function () {
    ...
    describe('Find', function () {
        it('should build projection', function (done) {
            ...
            var project = returns.buildProjection(projection);
    ...
    it('should find one document', function (done) {
        ...
        var req = {};
        req.params = {};
        req.params.id = returnId;
        returns.findOne(req, res, next);
    });
    ...
    it('should update a document', function (done) {
        ...
        returns.updateOne(req, res, next);
    });
    describe('Delete', function () {
        ...
        it('should delete one data', function (done) {
            ...
            returns.deleteOne(req, res, next);
        });
