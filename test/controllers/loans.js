...
var objId1 = db.Loans._mongoose.Types.ObjectId();
describe('Loans controller', function () {
    ...
    describe('Find', function () {
        it('should build projection', function (done) {
            ...
            var project = loans.buildProjection(projection);
