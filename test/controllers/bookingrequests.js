...
var bookingrequests = require('../../controllers/Bookingrequests.js');
...
var bookingrequestId2;
var lastId;
var forDelete;
var trashId;
var from = new Date(new Date().setMinutes(new Date().getMinutes() - 3)).toISOString();
var objId1 = db.Bookingrequests._mongoose.Types.ObjectId();
describe('Bookingrequests controller', function () {
    it('should create documents', function (done) {
        ...
        bookingrequests.create(req, res, next);
    });
    ...
    describe('Find', function () {
        it('should build projection', function (done) {
            ...
            var project = bookingrequests.buildProjection(projection);
        ...
        it('should search for matching documents for a given string', function (done) {
            ...
            bookingrequests.find(req, res, next);
        });
        ...
        it('should populate data of a references', function (done) {
            ...
            var req = {};
            req.query = { _id: bookingrequestId };
    ...
    it('should find one document', function (done) {
        ...
        var req = {};
        req.params = {};
        req.params.id = bookingrequestId;
        bookingrequests.findOne(req, res, next);
    });
    it('should update documents', function (done) {
        ...
        bookingrequests.update(req, res, next);
    });
    it('should update a document', function (done) {
        ...
        bookingrequests.updateOne(req, res, next);
    });
    describe('Delete', function () {
        it('should delete multiple data', function (done) {
            ...
            bookingrequests.delete(req, res, next);
        });
        ...
        it('should delete one data', function (done) {
            ...
            bookingrequests.deleteOne(req, res, next);
        });
    ...
    describe('Restore', function () {
        it('should restore a previously deleted data', function (done) {
            ...
            bookingrequests.restore(req, res, next);
        });
    });
});
