...
var objId1 = db.Bookings._mongoose.Types.ObjectId();
describe('Bookings controller', function () {
    ...
    describe('Find', function () {
        it('should build projection', function (done) {
            ...
            var project = bookings.buildProjection(projection);
    ...
    it('should update a document', function (done) {
        ...
        bookings.updateOne(req, res, next);
    });
    describe('Delete', function () {
        ...
        it('should delete one data', function (done) {
            ...
            bookings.deleteOne(req, res, next);
        });
