...
module.exports = {
    ...
    mongoURL: process.env.MONGOLAB_URL || 'mongodb://localhost/pretatousbeDev',
    logMongoURL: process.env.LOG_MONGOLAB_URL || 'mongodb://localhost/pretatousbeLogsDev',
    ...
    clockTimezone: process.env.CLOCK_TIMEZONE || 'Europe/Paris',
